...
const getRiseFallSpeed = (distToFall, fallSpeed, deltaTime) => {
    let fallDist = fallSpeed * deltaTime;
    ...
    func: function (event, arg) {
        ...
        for (const id of g.ids) {
            ...
            if ((gc?.fall ?? true) && curH > trnH) {
                ...
                const fallDist = getRiseFallSpeed(distToFall, g.fallSpeed, arg.deltaTime);
                ...
                if (limit == null || distToRise <= limit) {
                    ...
                    if (speed != null) {
                        ...
                        const riseDist = getRiseFallSpeed(distToRise, g.fallSpeed, arg.deltaTime);

...
const Vec = {
    ...
    min(other, result) {
        ...
        if (typeof other == "number") {
            for (let i = 0; i < this.length; i++)
                result[i] = Math.min(this[i], other);
        } else {
            for (let i = 0; i < this.length; i++)
                result[i] = Math.min(this[i], other[i]);
        }
    ...
    max(other, result) {
        ...
        if (typeof other == "number") {
            for (let i = 0; i < this.length; i++)
                result[i] = Math.max(this[i], other);
        } else {
            for (let i = 0; i < this.length; i++)
                result[i] = Math.max(this[i], other[i]);
        }
    ...
    projNorm(other) {
        return this.dot(other) / this.sqrMag;
    },
